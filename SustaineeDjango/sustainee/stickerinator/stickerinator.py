...
def process_img(filename, add_border, crop, threshold=150):
    ...
    #fim.save(f'processed/output.png')
    return fim


def stickerinator(filename):
    margin_filename = add_margin(filename)
    return process_img(margin_filename, add_border=False, crop=False)
